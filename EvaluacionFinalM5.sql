...
CREATE TABLE asesorias (
    ...
    fecharealizacion              VARCHAR2 (40),
    motivo                        VARCHAR2(100),
    cliente_rutcliente            NUMBER(9) NOT NULL,
    profesionales_runprofesional  NUMBER(9) NOT NULL
);
...
CREATE TABLE asistentes (
    ...
    asisnombrecompleto           VARCHAR2(100) NOT NULL,
    asisedad                     NUMBER(3) NOT NULL,
    asiscorreo                   VARCHAR2(70),
    asistelefono                 VARCHAR2(20),
...
--Crear secuencia autoincrementable para tabla asesorias
CREATE SEQUENCE asesorias_seq START WITH 1;
...
--Crear secuencia autoincrementable para tabla asistentes
CREATE SEQUENCE asistentes_seq START WITH 1;

CREATE OR REPLACE TRIGGER asistentes_bir 
BEFORE INSERT ON asistentes
FOR EACH ROW
BEGIN
SELECT asistentes_seq.NEXTVAL
...
ADD CONSTRAINT asesorias_cliente_fk FOREIGN KEY ( cliente_rutcliente )
REFERENCES cliente ( rutcliente );

ALTER TABLE asesorias
ADD CONSTRAINT asesorias_profesionales_fk FOREIGN KEY ( profesionales_runprofesional )
REFERENCES profesionales ( runprofesional );
...
--Insercion de registros en tabla asistentes
INSERT INTO asistentes VALUES(null,'Francisco Silva',28,'francisco.silva@hotmail.com','+5697654321',
1);
INSERT INTO asistentes VALUES(null,'Fernanda Bustos',36,'fernanda.bustos@hotmail.com','+5698382882',
2);
