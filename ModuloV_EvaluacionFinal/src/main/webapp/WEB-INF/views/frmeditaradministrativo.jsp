   ...
   <header>
    ...
    <section class="contact-section">
            <div class="container">    
                    ...
                    <div class="col-12">
                        <h2 class="contact-title">Editar Administrativo</h2>
                    </div>
                    <div class="border p-3 form">
                         <form class="form-contact contact_form" action='<c:out value="${pageContext.request.contextPath}"/>/procesareditaradm' method="post"  >
        						<div class='col-12'>
                                    <div class='form-group'>
                                      <input class='form-control w-100' name='run_adm' id='run_adm' value= '<c:out value="${administrativo.getRun_adm()}" ></c:out>' onfocus='this.placeholder = ' onblur='this.placeholder = "ingrese el run del Administrativo"' placeholder='ingrese el run del Administrativo'>
                                    </div>
              					</div>
								<div class='col-12'>
                                    <div class='form-group'>
