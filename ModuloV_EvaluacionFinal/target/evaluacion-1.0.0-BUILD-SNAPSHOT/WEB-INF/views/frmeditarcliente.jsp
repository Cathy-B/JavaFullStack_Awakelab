   ...
   <header>
    ...
    <section class="contact-section">
            <div class="container">    
                    ...
                    <div class="col-12">
                        <h2 class="contact-title">Editar Cliente</h2>
                    </div>
                    <div class="border p-3 form">
                         <form class="form-contact contact_form" action='<c:out value="${pageContext.request.contextPath}"/>/procesareditarcli' method="post"  >
        					 	<div class='col-12'>
